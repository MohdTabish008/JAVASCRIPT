...
//now the most important aspect of this is that while i have given jumbotron & squares different random colours so the name of random colour generating functions associated with both of them must be different.If I try to use same function to give color to both of them random colors will be generated in only one of thrm.
